  ...
  <div class="hello">
    ...
    <div class="row">
      <div>
        ...
        <!--<input type="hidden" :value="{{ showText(base_amount + base.name + '=' + target_amount + target.name) }} " id="getCurr" />-->
      </div>
    </div>  
  </div>
</template>
...
export default {
  ...
  data () {
    return {
      ...
      base_amount: 1,
      target_amount: 1,
      props: [ "base_amount", "base.amount", "target_amount", "target.name"],
      text: "",
      span: ""
    }
  },
